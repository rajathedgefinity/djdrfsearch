# Generated by Django 2.2.8 on 2019-12-30 12:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('published', 'Published'), ('not_published', 'Not Published'), ('in_progress', 'In progress'), ('cancelled', 'Rejected')], default='published', max_length=100)),
